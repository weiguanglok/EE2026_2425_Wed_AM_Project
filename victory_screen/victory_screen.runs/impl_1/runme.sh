...
HD_PWD='C:/Users/stamp/Documents/NUS/Y2S1/EE2026/Project/victory_screen/victory_screen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log victory_screen_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source victory_screen_main.tcl -notrace
