...
HD_PWD='C:/Users/stamp/Documents/NUS/Y2S1/EE2026/Project/victory_screen/victory_screen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log victory_screen_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source victory_screen_main.tcl
