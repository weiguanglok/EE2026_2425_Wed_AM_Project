...
HD_PWD='C:/Users/user/OneDrive - National University of Singapore/Documents/GitHub/EE2026_2425_Wed_AM_Team_13_Project/MODS/MODS.runs/homescreen_background_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log homescreen_background.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source homescreen_background.tcl
