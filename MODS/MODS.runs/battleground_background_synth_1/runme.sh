...
HD_PWD='C:/Users/Tay Xu Yang/Documents/GitHub/EE2026_2425_Wed_AM_Team_13_Project/MODS/MODS.runs/battleground_background_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log battleground_background.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source battleground_background.tcl
